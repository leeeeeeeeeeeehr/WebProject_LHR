      ...
      <div class="contents">
        <div class="inner">
          <div class="board_write write_area">
         	 <h2>게시글 작성</h2>
<form name="writefreeFrm" method="post" enctype="multipart/form-data"
      action="../HS/write-free.do" onsubmit="return validateForm(this);">
    ...
    <tr class="line">
        ...
        <td><input type="file" name="ofile" /></td>
              ...
              <div class="etc_area">
                ...
                <li>
                  <a class="cancel_btn" href="../HS/list-free.do">뒤로가기</a>
                </li>
             </div>
</form>
            </div>
