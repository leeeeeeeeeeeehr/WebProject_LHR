...
<body>
  ...
  <div id="wrap">
    ...
    <main id="contaniner" class="list_page sub_container">
      <div class="sub_visual file_visual">
        <div class="inner">
          ...
          <div class="board_list">
            ...
            <table>
              <thead>
				...
				<c:choose>
					...
					<c:otherwise>
						<c:forEach items="${ fileboard }" var="row" varStatus="loop">
				        <tr>
				            <td>${ map.totalCount - (((map.pageNum - 1) * map.pageList) + loop.index)}</td>
				            <td class="td_left"><a class="view_btn" href="../HS/view-file.do?num=${ row.num }">${ row.title }</a></td> 
				            <td>${ row.id }</td>
			...
			<table width="90%">
				<tr align="center">
					...
					<td width="100"><button class="write_btn" type="button" onclick="location.href='../HS/write-file.do';">글쓰기</button></td>
					</c:if>
				</tr>
			</table>
          </div>
